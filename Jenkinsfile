    ...
    stages {
        ...
        stage('静态代码检测/单元测试') {
            steps {
                ...
                sh "mvn clean install sonar:sonar -Dsonar.projectKey=gameoflife -Dsonar.projectName=gameoflife -Dsonar.projectVersion=1.0 -Dsonar.sourceEncoding=UTF-8 -Dsonar.exclusions=src/test/** -Dsonar.sources=src/ -Dsonar.java.binaries=target/classes -Dmaven.jacoco.reportPaths=target/jacoco.exec -Dsonar.host.url=http://192.168.0.115:9000 -Dsonar.login=ce36c58d80c50b7fb6456c21425a7359b959df10"
